            ...
            <Collapse in={shippingOpen}>
                <form id="shipment-form">
                    <div className="w-100">
                        ...
                        <center>
                            <input type="checkbox" name="billing-address" onClick={() => setBillingAddress(!billingAddress)} defaultChecked={true} />
                            <label className="mx-2" htmlFor="billing-address">Billing Address same as Shipping Address</label>
                        </center>
                    </div>
                </form>
            </Collapse>
            ...
            >
                <div className="d-flex justify-content-between align-items-center">
                    <input
                        ...
                        checked={pickupOpen}
                    />
                    <label htmlFor="shipping-checkbox">In Store Pickup</label>
                </div>
            </div>

            <Collapse in={pickupOpen}>
                <form id="pickup-form">
                    <div>
                        <div className="row">
                            <div
