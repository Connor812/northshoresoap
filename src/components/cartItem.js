...
function CartItem({ item, index, removeItem, updateQuantity }) {
            ...
            <div className="cart-item-details">
                ...
                <div className='quantity-container'>
                    ...
                    <span className='quantity-number-container'>
                        <button className="quantity-arrow-btn" onClick={() => updateQuantity(item.id, "increase")}>
                            <svg width="20" height="20" viewBox="0 0 16 16">
                                <path d="M7.776 5.553a.5.5 0 0 1 .448 0l6 3a.5.5 0 1 1-.448.894L8 6.56 2.224 9.447a.5.5 0 1 1-.448-.894z" />
                            </svg>
                        </button>
                        <span className="cart-item-quantity">{item.quantity}</span>
                        <button className="quantity-arrow-btn" onClick={() => updateQuantity(item.id, "decrease")}>
                            <svg width="20" height="20" viewBox="0 0 16 16">
